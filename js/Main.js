// Jquery para el menu del restaurante
$(document).ready(function(){
    
    $("#desayunos").hide();
    $("#bocadillos").hide();
    $("#bebidas-frias").hide();
    $("#bebidas-calientes").hide();
    $("#postres").hide();
    $("#platos-fuertes").hide();

   $(".VerDesayunos").click(function(){
       
    $("#desayunos").slideToggle("slow");
   })

   $(".VerBocadillos").click(function(){
       
    $("#bocadillos").slideToggle("slow");  
    
   })

   $(".VerBebidasF").click(function(){
       
    $("#bebidas-frias").slideToggle("slow");  
    
   })

   $(".VerBebidasC").click(function(){
       
    $("#bebidas-calientes").slideToggle("slow");  
    
   })

   $(".VerPostres").click(function(){
       
    $("#postres").slideToggle("slow");  
    
   })
   

   $(".VerPlatosF").click(function(){
       
    $("#platos-fuertes").slideToggle("slow");  
   ...
   $(".cardPlatillo").hover(
    function() {
      ...
      $(this).find(".card-body").append('<p class="extra-info text-muted">¡Haz tu pedido ya!</p>');
      $(this).find(".card-body").append('<button class="btn btn-sm btn-warning mt-2 btnTemp">Agregar</button>');
      
    },
    function() {
      // Al quitar el mouse: eliminar el mensaje agregado
      $(this)
        .find(".card-body")
        .find(".extra-info")
        .remove();
